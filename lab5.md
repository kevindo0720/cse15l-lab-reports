...
In this lab, I will redo lab report 3 but with a differnet command. In lab report 3, I demonstrated the alternative terminal commands to `less`, here, I will 
